			...
			<div class="container">
				<div class="signup-content">
						...
						<form method="post" action="Register" class="register-form"
							...
							<div class="form-group">
								<label for="name"><i
									...
									type="text" name="nom" id="nom" required="required" placeholder="Your Name" />
							</div>
							<div class="form-group">
								<label for="name"><i
									class="zmdi zmdi-account material-icons-name"></i></label> <input
									type="text" name="prenom" id="prenom" required="required" placeholder="Your SurName" />
							</div>
							<div class="form-group">
								<label for="name"><i
									class="zmdi zmdi-account material-icons-name"></i></label> <input
									type="text" name="name" id="name" required="required" placeholder="Your UserName" />
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="password" name="re_pass" required="required" id="re_pass"
					...
					<div class="signup-image">
						<figure>
							<img src="images/s.jpg" alt="sing up image">
						</figure>
...
<script type="text/javascript">
 var status=document.getElementById("status").value;
	 if (status=="success"){
		swal("Congrat", "Account Created Successfuly", "success");	 
		...
		swal("Sorry", "Please Enter Password", "error");	 
		 ...
		 swal("Sorry", "Password don't match", "error");
	 }
